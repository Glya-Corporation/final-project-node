...
const template2 = user => {
    ...
    <div align="left" class="alignment" style="line-height:10px"><img alt="Image" src="https://github.com/Glya-Corporation/final-project-node/blob/main/src/template/images/lindo-logo-carrito-compras_23-2148453859.png?raw=true" style="display: block; height: auto; border: 0; width: 195px; max-width: 100%;" title="Image" width="195"/></div>
    </td>
    </tr>
    </table>
    </td>
